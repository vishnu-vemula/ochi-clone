      ...
      {isOpen && (
        ...
        >
          ...
          <div className="flex items-center justify-between px-6 lg:px-12 py-4">
            <svg width="72" height="30" viewBox="0 0 72 30" fill="none" className="text-white">
              <path d="M9.8393 10.2032C4.22951 10.3257 -0.0459221 14.7356 0.000372391 20.2752C0.0412204 25.3548 4.57808 30.3608 10.6862 29.9226C15.5145 29.5768 19.9015 25.4119 19.8525 20.0057C19.8035 14.5995 15.1904 10.0916 9.8393 10.2032Z" fill="currentColor"/>
              <path d="M62.8086 29.4855H67.1222V10.6372H62.8086V29.4855Z" fill="currentColor"/>
              <path d="M67.6816 0.172852V6.13439H71.5322C71.6738 6.13439 71.8046 6.13439 72.0006 6.11534V0.172852H67.6816Z" fill="currentColor"/>
              <path d="M31.5648 25.7016C28.5393 25.7016 26.0667 23.1156 26.0776 19.9851C26.0936 18.5291 26.6764 17.1366 27.7023 16.1029C28.7282 15.0692 30.1166 14.4757 31.573 14.4482C32.4198 14.4541 33.2537 14.6557 34.0095 15.0373C34.7654 15.4188 35.4227 15.97 35.9301 16.6477L40.0667 15.0144C38.2884 12.0853 35.0669 10.1145 31.4995 10.1989C25.8897 10.3214 21.6142 14.7313 21.6605 20.2709C21.7014 25.3505 26.2382 30.3565 32.3464 29.9183C33.9908 29.7803 35.5761 29.2408 36.9631 28.347C38.3501 27.4532 39.4963 26.2326 40.3009 24.7924L36.2542 22.9931C35.7705 23.8086 35.0851 24.486 34.2638 24.9604C33.4426 25.4347 32.5132 25.69 31.5648 25.7016Z" fill="currentColor"/>
              <path d="M52.4097 10.1387C51.2512 10.1119 50.1066 10.3947 49.0941 10.958C48.0816 11.5212 47.2379 12.3445 46.6501 13.3427V0.172852H42.293V29.4688H46.6501V18.7816C46.6501 15.6946 47.8619 13.4352 50.8084 13.4352C54.6046 13.4352 54.6209 17.4178 54.6209 19.6962V28.7393V29.4987H59.0271V29.1721C59.0488 25.5108 59.0951 21.8522 59.0325 18.1909C58.9916 15.6538 58.5015 10.1387 52.4097 10.1387Z" fill="currentColor"/>
            </svg>
    ...
    <section className="min-h-screen bg-ochi-cream pt-24 lg:pt-20 px-5 lg:px-12 relative flex flex-col">
      ...
      >
        ...
        <div className="flex items-center gap-2">
          ...
          <button className="w-11 h-11 border border-ochi-zinc rounded-full flex items-center justify-center hover:bg-ochi-zinc hover:text-white transition-all duration-300">
...
function MarqueeSection() {
  return (
    <section className="bg-ochi-green text-white py-8 lg:py-12 relative overflow-hidden">
      {/* Rounded corners */}
      <div className="absolute top-0 left-0 w-full h-8 bg-ochi-cream" style={{ borderRadius: '0 0 50% 50% / 0 0 100% 100%' }} />
      <div className="absolute bottom-0 left-0 w-full h-8 bg-ochi-cream" style={{ borderRadius: '50% 50% 0 0 / 100% 100% 0 0' }} />
...
function AboutSection() {
  return (
    <section className="bg-ochi-lime py-16 lg:py-24 px-5 lg:px-12 relative">
      {/* Rounded corner */}
      <div className="absolute top-0 left-0 w-full h-8 bg-ochi-green" style={{ borderRadius: '0 0 50% 50% / 0 0 100% 100%' }} />
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4">
          ...
          <div className="bg-ochi-green text-ochi-lime rounded-xl p-8 h-72 lg:h-80 flex flex-col justify-between">
            <svg width="100" height="40" viewBox="0 0 72 30" fill="currentColor">
              ...
              <path d="M31.5648 25.7016C28.5393 25.7016 26.0667 23.1156 26.0776 19.9851C26.0936 18.5291 26.6764 17.1366 27.7023 16.1029C28.7282 15.0692 30.1166 14.4757 31.573 14.4482C32.4198 14.4541 33.2537 14.6557 34.0095 15.0373C34.7654 15.4188 35.4227 15.97 35.9301 16.6477L40.0667 15.0144C38.2884 12.0853 35.0669 10.1145 31.4995 10.1989C25.8897 10.3214 21.6142 14.7313 21.6605 20.2709C21.7014 25.3505 26.2382 30.3565 32.3464 29.9183C33.9908 29.7803 35.5761 29.2408 36.9631 28.347C38.3501 27.4532 39.4963 26.2326 40.3009 24.7924L36.2542 22.9931C35.7705 23.8086 35.0851 24.486 34.2638 24.9604C33.4426 25.4347 32.5132 25.69 31.5648 25.7016Z"/>
              <path d="M52.4097 10.1387C51.2512 10.1119 50.1066 10.3947 49.0941 10.958C48.0816 11.5212 47.2379 12.3445 46.6501 13.3427V0.172852H42.293V29.4688H46.6501V18.7816C46.6501 15.6946 47.8619 13.4352 50.8084 13.4352C54.6046 13.4352 54.6209 17.4178 54.6209 19.6962V28.7393V29.4987H59.0271V29.1721C59.0488 25.5108 59.0951 21.8522 59.0325 18.1909C58.9916 15.6538 58.5015 10.1387 52.4097 10.1387Z"/>
            </svg>
            <div>
